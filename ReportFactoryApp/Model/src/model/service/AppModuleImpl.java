...
//        vo.setNamedWhereClauseParam("P201_CHALLAN_NO", LV_CHALLANNO);
    ...
    /**
     * Container's getter for PendingReturnGatePassVO1.
     * @return PendingReturnGatePassVO1
     */
    public ViewObjectImpl getPendingReturnGatePassVO1() {
        return (ViewObjectImpl) findViewObject("PendingReturnGatePassVO1");
    }
    public void callPendingReturnGatePass(String LV_UNIT,Date FRDATE,Date TODATE , Date TRDATE ){
        ViewObjectImpl vo = this.getPendingReturnGatePassVO1();
        System.out.println(LV_UNIT + "--"  + FRDATE + "--" + TODATE+"--" + TRDATE );
        
    if ( LV_UNIT != null &&  FRDATE != null && TODATE != null && TRDATE !=null ) {
        System.out.println("Inside condition!");
    try {

        
        vo.setNamedWhereClauseParam("P10_UNIT", LV_UNIT);
        vo.setNamedWhereClauseParam("P10_FR_DT", FRDATE);
        vo.setNamedWhereClauseParam("P10_TO_DT", TODATE);
        vo.setNamedWhereClauseParam("P10_DT", TRDATE);
    ...
    /**
     * Container's getter for FinancialTransactionsVO1.
     * @return FinancialTransactionsVO1
     */
    ...
    /**
     * Container's getter for MonthWisetotalTransactionsVO1.
     * @return MonthWisetotalTransactionsVO1
     */
    public ViewObjectImpl getMonthWisetotalTransactionsVO1() {
        return (ViewObjectImpl) findViewObject("MonthWisetotalTransactionsVO1");
    }
    public void callMonthwiseTotalTransaction(String LV_UNIT,Date FRDATE,Date TODATE ,String LV_VOUCHERTYPE ){
            ViewObjectImpl vo = this.getMonthWisetotalTransactionsVO1();
//            LV_VOUCHERTYPE = "SALES VOUCHER";
            System.out.println(LV_UNIT + "--"  + FRDATE + "--" + TODATE+"--" + LV_VOUCHERTYPE );
            
        if ( LV_UNIT != null &&  FRDATE != null && TODATE != null &&  LV_VOUCHERTYPE != null) {
            System.out.println("Inside condition!");
        try {

            
            vo.setNamedWhereClauseParam("P473_UNIT_CD", LV_UNIT);
            vo.setNamedWhereClauseParam("P473_FROM_DATE", FRDATE);
            vo.setNamedWhereClauseParam("P473_TO_DT", TODATE);  
            vo.setNamedWhereClauseParam("P473_VOUCHER_TYPE", LV_VOUCHERTYPE);
