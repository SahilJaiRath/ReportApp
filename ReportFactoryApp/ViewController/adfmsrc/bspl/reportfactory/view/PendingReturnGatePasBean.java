...
public class PendingReturnGatePasBean {
    public PendingReturnGatePasBean() {
    }
    ...
    public void onClickButton(ActionEvent actionEvent) {
        ...
        oracle.jbo.domain.Date TrDate = (oracle.jbo.domain.Date) pvIter.getCurrentRow().getAttribute("toDate");

        

        
        BindingContainer bindings = BindingContext.getCurrent().getCurrentBindingsEntry();  
        OperationBinding operationBinding = bindings.getOperationBinding("callPendingReturnGatePass");
        operationBinding.getParamsMap().put("LV_UNIT",Unit);
        operationBinding.getParamsMap().put("TRDATE", TrDate);
