...
public class FGTransferBean {
    public FGTransferBean() {
    }
    ...
    public void onClickButton(ActionEvent actionEvent) {
        ...
        String ChallanType = (String) pvIter.getCurrentRow().getAttribute("ChallanType");
        ...
        OperationBinding operationBinding = bindings.getOperationBinding("callFGTransfer");
        operationBinding.getParamsMap().put("LV_UNIT",Unit);
        operationBinding.getParamsMap().put("LV_ChallanType", ChallanType);
