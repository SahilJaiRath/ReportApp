...
public class IncomingInspectionRegisterBean {
    public IncomingInspectionRegisterBean() {
    }
...
//             ItemCD = ItemCD.split(",")[0];
        ...
        OperationBinding operationBinding = bindings.getOperationBinding("callIncomingInspectionRegister");
