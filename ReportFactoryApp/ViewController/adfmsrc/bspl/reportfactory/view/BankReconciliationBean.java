...
public class BankReconciliationBean {
    ...
    public void onClickButton(ActionEvent actionEvent) {
        ...
        String GL = (String) pvIter.getCurrentRow().getAttribute("BankReconcilation_GL");
        ...
        OperationBinding operationBinding = bindings.getOperationBinding("callBankRecociliation");
        operationBinding.getParamsMap().put("LV_GL",GL);
