...
public class JVSalePurchaseContraBookBean {
    public JVSalePurchaseContraBookBean() {
    }
...
//             ItemCD = ItemCD.split(",")[0];
        ...
        OperationBinding operationBinding = bindings.getOperationBinding("callJVSalePurchaseContraBook");
